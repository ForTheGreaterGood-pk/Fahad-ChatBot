...
Developers : Muhammad Fahad Alam    Ahsan   Ishaq
...
option_2 = Label (frame_topic , text = '2- Pakistan' , font = 'Verdana 15 italic' , bg = c1 , fg= c2)
...
option_3 = Label (frame_topic , text = '3-  Islamic History ' , font = 'Verdana 15 italic' ,bg = c1 , fg= c2)
...
option_4 = Label (frame_topic , text = '4- Units of physical Quantities   ' , font = 'Verdana 15 italic' , bg = c1 , fg= c2)
...
option_5 = Label (frame_topic , text = '5-  Input Output Devices ' , font = 'Verdana 15 italic' , bg = c1 , fg= c2)
